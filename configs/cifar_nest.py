...
# ==============================================================================
"""A config for training NesT on CIFAR."""
...
def get_config():
  ...
  Configurations for NesT-B, Nest-S, Nest-T respectively.
    [{
        "model_name": "nest_base_s16_32",
        "per_device_batch_size": 32,
    }
    {
        "model_name": "nest_small_s16_32",
        "per_device_batch_size": 64,
    },
    {
        "model_name": "nest_tiny_s16_32",
        "per_device_batch_size": 192,
    }]

  """
  config = ml_collections.ConfigDict()
  config.model_name = "nest_tiny_s16_32"
  config.per_device_batch_size = 192
  ...
  # If randaugment_magstd set, randaugment_magnitude has be set also.
  config.augment.randaugment_magstd = 0.5
  config.augment.size = 32
  # Add random erasing.
